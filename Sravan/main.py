...
while True:
  ...
  print("1.Enter a new cost charge")
  print("2.View cost charges summary")
  choice = int(input())
  if choice == 1:
    date = input("Enter the date of the cost charges (YYYY-MM-DD): ")
    description = input("Enter the description of the cost charge: ")
    ...
    price=input("enter the price of the cost charge: ")
    cur.execute("INSERT INTO expenses (Date,description,category,price) VALUES (?,?,?,?)",(date,description,category,price))
    conn.commit()
  elif choice==2:
    print("Select an option:")
    print("1.View all cost charges")
    print("2.View monthly cost charges by category")
...
tip=int(input("enter the percentage of tip? 5,8,10: "))
